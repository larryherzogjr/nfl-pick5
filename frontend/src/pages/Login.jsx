      ...
      <div className="w-full max-w-sm space-y-6 rounded-lg bg-white p-8 shadow">
        ...
        {loginError === "email_already_registered" && (
          <div className="rounded-md border border-red-200 bg-red-50 p-3 text-sm text-red-800">
            That email is already registered. Sign in with the Google account
        ...
        {showWarning && (
          <div className="rounded-md border border-amber-300 bg-amber-50 p-3 text-sm text-amber-900">
            ...
            <p className="mt-1">
              Google blocks sign-in from in-app browsers for security. To use
              Google, tap the <span className="font-semibold">⋯</span> menu and
              choose{" "}
